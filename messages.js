				...
				$("#message").keydown(function(event){
					if ( event.which === 13 ) {
						event.preventDefault( );
						 ...
						 "user": {
						 "name": "Sagar",
						 "image": "https://media.licdn.com/dms/image/C5103AQE_r4LBkclX0A/profile-displayphoto-shrink_200_200/0?e=1547683200&v=beta&t=NMaIFr5NkUo1Ntq-H3e51g6RWv1CIYt4YwCvaN3DuQ0"
						 },
						 "message": {
